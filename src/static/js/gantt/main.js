...
angular.module('angularGanttDemoApp')
    .controller('MainCtrl', ['$scope', '$timeout', '$log', 'ganttUtils', 'GanttObjectModel', 'Sample', 'ganttMouseOffset', 'ganttDebounce', 'moment', function($scope, $timeout, $log, utils, ObjectModel, Sample, mouseOffset, debounce, moment) {
        ...
        $scope.options = {
            ...
            fromDate: moment(function(){var d=new Date(2015,9,15); d.setDate(d.getDate()-7); return d;}()).format("YYYY-MM-DD"),
            toDate: moment(function(){var d=new Date(2015,9,15); d.setDate(d.getDate()+30); return d;}()).format("YYYY-MM-DD"),
            rowContent: '<i class="fa fa-align-justify"></i> {{row.model.name}}',
            taskContent : '<i class="fa fa-tasks"></i> {{task.model.name}}',
            allowSideResizing: true,
            labelsEnabled: true,
            currentDate: 'line',
            currentDateValue: moment(function(){var d=new Date(2015,9,15); d.setHours(12,0,0); return d;}()).format("YYYY-MM-DD"),
            draw: false,
            readOnly: false,
